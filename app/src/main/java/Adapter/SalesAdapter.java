    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       /* if (position > 0 ) {
        ...
        try {
            ...
            holder.Total.setText(String.valueOf(Double.parseDouble(holder.SPrice.getText().toString()) / (Float.parseFloat(holder.conversionfactor.getText().toString())) * (Double.parseDouble(holder.Quantity.getText().toString()))));
            ...
            TextWatcher quantityTextChangeWatcher = new TextWatcher() {
                ...
                public void afterTextChanged(Editable s) {
                    try {
                        ...
                        holder.Total.setText(String.valueOf(Double.parseDouble(holder.SPrice.getText().toString()) / (Double.parseDouble(holder.conversionfactor.getText().toString())) * (Double.parseDouble(holder.Quantity.getText().toString()))));
                        // holder.StockQuant.setText(String.valueOf(Float.parseFloat(holder.StockQuant.getText().toString()) * (Float.parseFloat(holder.conversionfactor.getText().toString()))));
